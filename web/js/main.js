...
UMobileAd.prototype.preloadImages = function(parent) {
    ...
    str = str + 'var pic1 = new Image();' +
        ...
        'var pic8 = new Image();' +
        'var pic9 = new Image();' +
        'pic1.src=sdk.path+"img/explosion.png";' +
        'pic2.src=sdk.path+"img/hero.png";' +
        'pic3.src=sdk.path+"img/screen1-bg.png";' +
        'pic4.src=sdk.path+"img/screen2-bg.png";' +
        'pic5.src=sdk.path+"img/screen3-bg.png";' +
        'pic6.src=sdk.path+"img/screen4-bg.png";' +
        'pic7.src=sdk.path+"img/screen5-bg.png";' +
        'pic8.src=sdk.path+"img/screen6-bg.png";' +
        'pic9.src=sdk.path+"img/screen8-bg.png";';
